...
Dans cette annexe, nous présentons les résultats des expériences de la troisième partie de la Section \ref{sec:bm:experiments}. Pour obtenir une meilleure mise en forme, le format de données est différente de celui dans la Section \ref{sec:bm:experiments}. ``Taux'' d'ici n'a pas de marque de pourcentage parce qu'il est le taux de compression calculé par la division de la taille de données d'origine et de la taille compressée.
...
\caption{Évaluation de $s_0 \wedge s_1$ avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de $s_0 \vee s_1$ avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de $\X s_0$ avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de $\G s_0$ avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de $\F s_0$ avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de $s_0 \textbf{U} s_1$  avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de $s_0 \textbf{W} s_1$  avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de $s_0 \textbf{R} s_1$  avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F1 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F2 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F3 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F4 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F5 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F6 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F7 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F8 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F9 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F10 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F11 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F12 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F13 avec les algorithmes de compression}
\end{table}
...
\caption{Évaluation de la formule F14 avec les algorithmes de compression}
\end{table}
